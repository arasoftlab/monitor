...
<div class="col-xs-12 panel-group pull-left" style="margin-top: 15px;">
													...
													<div id="setting_${item.idx }" class="optionList row"
														...
														<div class="col-xs-12">
															...
															<div class="col-xs-2" style="padding-left: 10px; width: 105px;">
																...
																<div id="pollImageAdd" class="col-xs-4">
												...
												<c:forEach var="item" items="${settingsList }" varStatus="i">
													<div id="setting_${item.idx }" class="optionList row"
														...
														<div class="col-xs-12">
															...
															<div class="col-xs-2" style="padding-left: 10px; width: 115px;">
																<div class="col-xs-5">
																	<a id="btn_del"	class="btn btn-default btn-sm icon_btn delete"	onclick="fnDeleteSettings('${item.idx}');"> 
																		<i class="fa fa-1x fa-times"></i>
																	</a>
