...
<footer style="background:none; text-align:-webkit-center;">
	...
	<div class="col-xs-12" style="text-align:center; float:none !important;">
...
-->
		<button class="btn btn-theme" onclick="chkValidation()" style="margin:20px 0 10px 0;"><i class="fa fa-2x fa-caret-square-o-right"></i><br/><span style="font-size:8pt;">다음</span></button>
	</div>
