...
<div style="text-align: center;margin-top:-24%; font-weight: bold; font-size: 16px;padding-bottom: 215px; height:100%">
불편을 드려서 죄송합니다.<br>
...
<a href="javascript:history.back();" style="color:#5CD1E5;">[이전페이지로 이동]</a>
</div>
