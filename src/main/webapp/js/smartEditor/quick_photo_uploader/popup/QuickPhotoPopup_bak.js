    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/file/smartEditorFileUploadHtml5.do'; 	//upload URL
    ...
    function callAjaxForHTML5 (tempFile, sUploadURL){
		...
		oAjax.header("file_name",encodeURIComponent(tempFile.name));
		oAjax.header("file_size",tempFile.size);
		oAjax.header("file_Type",tempFile.type);
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			...
 			sUrl  : '/file/smartEditorFileUpload.do',	//샘플 URL입니다.
