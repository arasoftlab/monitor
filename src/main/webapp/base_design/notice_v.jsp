				...
				<table class="table table-bordered table-margin">
					<tbody>
						<tr>
							...
							<td colspan=3 class="left">제 11차 현장 과제(서울대공원 동물서식지 문화축제)</td>
						</tr>
						<tr>
							<td class="td1">등록일</td>
							<td class="left">2016/08/12</td>
							<td class="td1">조회수</td>
							<td class="left">213</td>
						</tr>
						<tr>
							<td class="td1">공지종류</td>
							<td colspan=3 class="left">
								<label class="col-sm-4"><input type="radio" value="filed" name="filed" checked disabled>&nbsp;현장과제(참여모집 공고)</label>
								<label class="col-sm-4"><input type="radio" value="survey" name="survey"  disabled>&nbsp;설문과제(지정과제)</label>
								<label class="col-sm-4"><input type="radio" value="simple" name="simple"  disabled>&nbsp;단순, 일반공지</label>
							</td>
						</tr>
						<tr>
							<td class="td1">연결과제</td>
							<td colspan=3 class="left">2016 제 1차 현장과제 모니터링</td>
						</tr>
						<tr>
						...
						<tr>
							<td class="td1">공지종류</td>
							<td colspan=3 class="left">
								<label class="col-sm-4"><input type="radio" value="open" name="open" checked disabled>&nbsp;홈 공개</label>
								<label class="col-sm-4"><input type="radio" value="close" name="close"  disabled>&nbsp;홈 비공개</label>
							</td>
						</tr>
						<tr>
