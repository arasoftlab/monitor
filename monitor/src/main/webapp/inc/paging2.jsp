...
<div id="page-wrap" style="text-align:center;margin-top:10px">
	<ul class="pagination">
	  ...
	  <c:if test="${vo.pageNum > 10}">
		  <li style="padding: 1px 0;margin-right:5px;"><a href="javascript:fnGoList('1');" style="font-size: 14px;margin-right:5px;">&laquo;</a></li>
	  </c:if>
	  
	  <c:if test="${vo.pageNum > 1}">
		  <li style="padding: 1px 0;"><a href="javascript:fnGoList(${vo.pageNum -1});" style="font-size: 14px;">◀</a></li>
	  </c:if>
	  
	  <c:forEach begin="${s_page * 10 + 1 }" end="${e_page * 10 + 10}" var="pageNum">
	  ...
	  <c:if test="${page.totalPage - vo.pageNum > 10}">
		  <li style="padding: 1px 0;"><a href="javascript:fnGoList('${page.totalPage }');" style="font-size: 14px;margin-left:5px;">&raquo;</a></li>
	  </c:if>
